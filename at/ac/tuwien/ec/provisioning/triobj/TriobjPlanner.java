...
import org.uma.jmetal.operator.crossover.*;
import org.uma.jmetal.operator.mutation.*;
import org.uma.jmetal.operator.selection.impl.*;
import org.uma.jmetal.problem.Problem;
import org.uma.jmetal.qualityindicator.impl.hypervolume.impl.*;
import org.uma.jmetal.util.*;
import org.uma.jmetal.util.comparator.*;
import org.uma.jmetal.util.evaluator.impl.*;
import org.uma.jmetal.util.point.*;
...
public class TriobjPlanner extends EdgePlanner{
	...
	public List<TriobjSolution> getSolutionList()
	{
		...
		try
		{
			//NSGAIIBuilder<TriobjSolution> nsgaBuilder = 
				//	new NSGAIIBuilder<TriobjSolution>(this.problem, this.crossoverOperator, this.mutationOperator,30);
	...
	public boolean setupEdgeNodes(MobileDataDistributionInfrastructure inf)
	{
		...
		{
			//NSGAIIBuilder<TriobjSolution> nsgaBuilder = 
				//	new NSGAIIBuilder<TriobjSolution>(this.problem, this.crossoverOperator, this.mutationOperator,100);
