...
public class KalmanFaaSPlacement extends FaaSPlacementAlgorithm {
	...
	public KalmanFaaSPlacement(FaaSWorkflow A, MobileDataDistributionInfrastructure I)
	{
		super();
	...
	public KalmanFaaSPlacement(Tuple2<FaaSWorkflow,MobileDataDistributionInfrastructure> arg)
	{
		super();
	...
	private double predictLatencyAtTimeStep(MobileSoftwareComponent msc, ComputationalNode previousTarget,
		...
		MobileDataDistributionInfrastructure future = infrastructure.predictAtTimestamp(d);
	...
	private Tuple2<ComputationalNode, Double> findTargetForTimestep(MobileSoftwareComponent msc,
		...
		{
			if((tmp = computeAverageLatency(msc, c, future, placement)) < avgLatency)
			{
