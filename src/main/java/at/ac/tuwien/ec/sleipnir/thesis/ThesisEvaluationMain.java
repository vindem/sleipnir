...
import at.ac.tuwien.ec.sleipnir.MontecarloStatisticsPrinter;
    ...
    for (String algoName : SimulationSetup.algorithms) {
      String filename =
          SimulationSetup.outfile
              ...
              + "-CLOUD="
              + SimulationSetup.cloudNum
              + "-EDGE="
              + SimulationSetup.edgeNodes
              + "-"
              ...
              + ((algoName.equals("weighted"))
                  ? "-alpha="
                      + SimulationSetup.EchoAlpha
                      + "-beta="
                      + SimulationSetup.EchoBeta
                      + "-gamma="
                      + SimulationSetup.EchoGamma
                  : "")
        ...
        input.flatMapToPair(
            new PairFlatMapFunction<
              ...
              public Iterator<
                ...
                ArrayList<OffloadScheduling> offloads =
                    (ArrayList<OffloadScheduling>) singleSearch.findScheduling();
                if (offloads != null)
